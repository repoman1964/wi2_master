...
if(isset($_POST["usernamecheck"])){
    ...
    if (strlen($username) < 3 || strlen($username) > 16) {
	    echo '<strong style="color:red;">3 - 16 characters please</strong>';
	    exit();
    }
...
<div id="pageMiddle">
  ...
  <form name="signupform" id="signupform" onsubmit="return false;">
    ...
    <div>
      <a href="terms_of_service.php" target = "_blank">View the Terms Of Use
      </a>
    </div>
    <div>
      <p>Already a club member? <a href="login.php"><strong>Click here</strong></a> to login.</p>
    </div>
